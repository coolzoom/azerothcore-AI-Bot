...
void WorldSession::HandleLogoutRequestOpcode(WorldPacket & /*recv_data*/)
{
    ...
    bool PreventAFKDisconnect = sWorld->getBoolConfig(CONFIG_PREVENT_AFK_DISCONNECT) && GetPlayer()->isAFK();
    ...
    else if (PreventAFKDisconnect || GetPlayer()->duel || GetPlayer()->HasAura(9454)) // is dueling or frozen by GM via freeze command
